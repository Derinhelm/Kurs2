...
def getNumberFromDB(variantsList, con, cursor):
    ...
    for curVariant in variantsList:
        ...
        numbersList.append((morphNumber, normalFormNumber))
    return numbersList
...
def insertPattern1(con, cursor, mainMorphNumber, depMorphNumber):
...
def insertPattern(con, cursor, mainMorphNumber, mainNormalFormNumber, depMorphNumber,  depNormalFormNumber):
        insertPattern3(con, cursor, mainMorphNumber, depMorphNumber, \
                      mainNormalFormNumber, depNormalFormNumber)
        insertPattern2(con, cursor, mainMorphNumber, depMorphNumber, \
                      mainNormalFormNumber)
        insertPattern1(con, cursor, mainMorphNumber, depMorphNumber)
    ...
    for curMain in mainInserts:
        for curDep in depInserts:
            ...
            insertPattern(con, cursor, mainMorphNumber, mainNormalFormNumber, \
                    depMorphNumber,  depNormalFormNumber)
