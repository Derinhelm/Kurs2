prep_type_dict = {'без': 'g', 'безо': 'g', 'благодаря': 'd', 'близ': 'g', 'в': 'ap', 'вблизи': 'g', 'ввиду': 'g',
                'вглубь': 'g', 'вдоль': 'g', 'взамен': 'g', 'включая': 'a', 'выключая': 'a', 'вкось': 'g', 'вкруг': 'g',
                'вместо': 'g', 'вне': 'g', 'внизу': 'g', 'внутри': 'g', 'внутрь': 'g', 'во': 'ap', 'вовнутрь': 'g',
                'возле': 'g', 'вокруг': 'g', 'вопреки': 'd', 'вперед': 'g', 'впереди': 'g', 'вроде': 'g', 'вослед': 'd',
                'вслед': 'd', 'вследствие': 'g', 'выше': 'g', 'для': 'g', 'до': 'g', 'за': 'ai', 'заместо': 'g',
                'из': 'g', 'изо': 'g', 'из-за': 'g', 'из-под': 'g', 'изнутри': 'g', 'исключая': 'a', 'к': 'd',
                'ко': 'd', 'касаемо': 'g', 'касательно': 'g', 'кроме': 'g', 'кругом': 'g', 'меж': 'gi', 'между': 'gi',
                'мимо': 'g', 'минус': 'a', 'на': 'ap', 'наверху': 'g', 'над': 'i', 'надо': 'i', 'навстречу': 'd',
                'наискось': 'g', 'накануне': 'g', 'наместо': 'g', 'наперекор': 'd', 'наперерез': 'd', 'наподобие': 'g',
                'напротив': 'g', 'насупротив': 'g', 'насчет': 'g', 'ниже': 'g', 'о': 'ap', 'об': 'ap', 'обо': 'ap',
                'обок': 'g', 'около': 'g', 'окрест': 'g', 'окромя': 'g', 'округ': 'g', 'опричь': 'g',
                'относительно': 'g', 'от': 'g', 'ото': 'g', 'перед': 'i', 'передо': 'i', 'плюс': 'a', 'пред': 'i',
                'предо': 'i', 'по': 'dap', 'по-за': 'a', 'по-над': 'i', 'поверх': 'g', 'под': 'ai', 'подле': 'g',
                'подо': 'ai', 'подобно': 'd', 'позади': 'g', 'позадь': 'g', 'помимо': 'g', 'поперек': 'g',
                'посереди': 'g', 'посередине': 'g', 'посередь': 'g', 'после': 'g', 'посреди': 'g', 'посредине': 'g',
                'посредством': 'g', 'превыше': 'g', 'прежде': 'g', 'при': 'p', 'про': 'a', 'промеж': 'g',
                'промежду': 'g', 'против': 'g', 'противно': 'g', 'путем': 'g', 'ради': 'g', 'с': 'gai', 'со': 'gai',
                'сбоку': 'g', 'сверх': 'g', 'сверху': 'g', 'свыше': 'g', 'середь': 'g', 'сзади': 'g', 'сквозь': 'a',
                'снизу': 'g', 'согласно': 'd', 'сообразно': 'd', 'соответственно': 'd', 'соразмерно': 'd',
                'спереди': 'g', 'спустя': 'a', 'среди': 'g', 'средь': 'g', 'сродни': 'd', 'супротив': 'g', 'у': 'g',
                'через': 'a', 'чрез': 'a', 'без ведома': 'g', 'близко от': 'g', 'вблизи от': 'g', 'в виде': 'g',
                'вдали от': 'g', 'вдоль по': 'd', 'в зависимости от': 'g', 'в знак': 'g', 'в качестве': 'g',
                'в кругу': 'g', 'в лице': 'g', 'в меру': 'g', 'в направлении к': 'd', 'во благо': 'gd',
                'во избежание': 'g', 'во имя': 'g', 'вместе с': 'i', 'в ответ на': 'a', 'в отличие от': 'g',
                'в отношении': 'g', 'в отношении к': 'd', 'в пандан': 'gd', 'в преддверии': 'g', 'в продолжение': 'g',
                'в противовес': 'd', 'впредь до': 'g', 'в результате': 'g', 'в роли': 'g', 'в связи с': 'i',
                'в силу': 'g', 'в соответствии с': 'i', 'вслед за': 'i', 'в сравнении с': 'i', 'в сторону от': 'g',
                'в течение': 'g', 'в целях': 'g', 'в центре': 'g', 'в честь': 'g', 'за вычетом': 'g',
                'за исключением': 'g', 'за счет': 'g', 'исходя из': 'g', 'лицом к': 'd', 'лицом к лицу с': 'i',
                'на благо': 'gd', 'на виду у': 'g', 'на глазах у': 'g', 'на предмет': 'g', 'на протяжении': 'g',
                'наравне с': 'i', 'наряду с': 'i', 'начиная с': 'g', 'не без': 'g', 'не говоря о': 'p',
                'незадолго до': 'g', 'не считая': 'g', 'недалеко от': 'g', 'независимо от': 'g', 'невзирая на': 'a',
                'несмотря на': 'a', 'одновременно с': 'i', 'от лица': 'g', 'от имени': 'g', 'по вопросу о': 'p',
                'по линии': 'g', 'по мере': 'g', 'по направлению к': 'd', 'по отношению к': 'd', 'по поводу': 'g',
                'по причине': 'g', 'по пути к': 'd', 'по случаю': 'g', 'по сравнению с': 'i', 'по части': 'g',
                'поблизости от': 'g', 'под видом': 'g', 'под эгидой': 'g', 'применительно к': 'd', 'при помощи': 'g',
                'рядом с': 'i', 'с ведома': 'g', 'следом за': 'i', 'смотря по': 'd', 'согласно с': 'i',
                'с помощью': 'g', 'с прицелом на': 'a', 'с течением': 'g', 'судя по': 'd', 'с точки зрения': 'g',
                'с целью': 'g'}
